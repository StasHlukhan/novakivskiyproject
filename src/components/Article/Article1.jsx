...
import './Article.css'
import Portret from '../../img/Portret_kvity.png'
import Zadum from '../../img/Zadum.png'
import Self_man from '../../img/Self_man.png'
import auto_musa from '../../img/auto_musa.png'
import Gera from '../../img/Gera.png'
  ...
  return (
    <div>
      ...
      <div className="article_info">
        <p className='article_text'>Олексу Новаківського називали “святоюрським магом” за вміння проявляти божественну природу в буденному. В дитинстві мав видіння як загубився у прадавньому лісі, що до нього звернувся Вищий і дав йому місію: розпаковувати сховану в буденному божественну красу. Після чого син лісника рішуче почав трансформувати свою долю і наперекір традиціям часу кардинально змінив свій фах, протурувавши дорогу до слави художника і вчителя. Новаківський творив не сумніваючись у вірності цієї задачі, а лише впадаючи у сумніви пошуку найкращої розпаковки, щоб аж захоплювало дух. І лише наприкінці життя він сказав своєму другові Голубовському: "А тепер я пан свого пензля".</p>
        <div  className="img_vert">
          <img  src={Portret} alt="" />
          <p className="caption_art">Автопортрет із букетом квітів, 1933 рік. Фанера, олія. З приватної колекції (в експозиції Музею Новаківського)</p>
        </div>
        <p className="article_text">Створив нову естетику національного мистецтва, синтезуючи українську етніку і українську та античну міфологію, релігійне мистецтво та західноєвропейський модерн. Художник спочатку працював під впливом імпресіонізму, пізніше символізму і експресіонізму. Польські критики ще за життя Олекси Новаківського порівнювали його з Едвардом Мунком і Вінсентом Ван Гогом. А в його творчості, яка проявляла призначення відкривати людям приховану красу божественної природи світу, резонував з професійними пошуками Клода Моне.</p>
        <div className="img_goriz">
          <img src={Zadum} alt="" />
          <p className="caption_art">О.Новаківський. «Дружина у задумі». Початок 1930-х рр.</p>
        </div>
        <p className="article_text">Найуспішніший випускник Краківської Академії красних мистецтв за кількістю медалей та відзнак, який з легкістю міг віднайти поціновувачів свого таланту у тогочасному Відні чи Парижі. Вважається учнем Яна Матейка. Особливий вплив на формування образного мислення мали корифеї польського символізму Станіслав Виспянський і Яцек Мальчевський, Йозеф Меггофер.  Після мандрівки до Італії 1931 року Олекса Новаківський обирає собі нового вчителя - Мікеланджело, - і створює низку творів серед яких серія “Леда” і “Мойсей”.</p>
        <div className="img_goriz">
          <img src={Self_man} alt="" />
        </div>
        <p className="article_text">Self made man, що створив свою легенду, бренд і авторський стиль. Везунчик, що отримував визнання і підтримку від меценатів в навчанні і реалізації як художник та вчитель. Посол УНР в Копенгагені і лідер демократичної партії Дмитро Левицький подарував йому дім в Дорі. Майстерню з видом на собор Юра отримав в дар від Андрея Шептицького. Він же був одним з найбіьших поціновувачем мистецьва Новаківського, а також партнером в багатьох спільних мистецьких та освітніх проектах і став опікуном синів Ярослава та Ждана після смерті Олекси. </p>
        <div className="img_goriz">
          <img src={auto_musa} alt="" />
          <p className='caption_art'>Автопортрет із музою, початок 1900-х років. Полотно, олія. З приватної колекції</p>
        </div>
        <p className="article_text">Улюбленець молоді і талановитий вчитель дорослих. Вів моду на пленери та переїзні виставки учнів після виїздів на природу. Серед його учнів відомі в Україні та в світі художники Роман Сельський, Григорій Смольський, Едвард Козак, Святослав Гординський, Мирон Левицький, Михайло Мороз. Загалом в Школі Новаківського безкоштовно навчалось понад 100 учнів з усіх куточків України — з Галичини, Буковини, Гуцульщини, навіть з Волині та Наддніпрянщини. Був професором в Українському таємному університеті, який часто проводив таємні навчання в майстерні художника.</p>
        <div className="img_goriz">
          <img src={Gera} alt="" />
          <p className="caption_art">Гора Грегіт, 1931 рік. Фанера, олія. Зі збірки Національного музею у Львові</p>
        </div>
        <p className="article_text">Львів'яни почасти не розуміли творчості митця і часто його критикували (дуже схожі історії знайдете в житті Моне, Ван Гога і навіть Клімпта, кожен з яких є символом великої трансформації мистецтва у епоху модерну). При тому він був одним з найдорожчих художників, твори якого мати в колекції було престижно. Що можна сказати про його картини і сьогодні. </p>
        <div className="img_goriz">
          <img src={Voina} alt="" />
          <p className="caption_art">Юр. Поема світової війни, 1916-1922 роки. Полотно на фанері, олія. З приватної колекції</p>
        </div>
        <p className="article_text">Єдиний з українських художників, хто зображав свою дружину з підліткового віку до її смерті. Його музою довгі роки була Анна-Марія - донька селян з села Могила, де тривалий час жив після завершення Краківської академії. Саме вона стала моделлю для епохальної теми, яку досліджував впродовж довгих років Олекса Новаківський через серію робіт «Пробудження». Наче з кожною візуалізацією екзистенційного пробудження України наближав втілення цієї мрії мільйонів українців, які невпинно боролись за неї на перетині століть. </p>
        <div className="img_vert">
          <img src={Probud} alt="" />
          <p className="caption_art">Пробудження на тлі розп»яття 1914 рік</p>
        </div>
      </div>
