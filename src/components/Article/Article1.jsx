  ...
  return (
    <div>
      ...
      <div className="article_info">
        ...
        <div className="img">
          <img src={Portret} alt="" />
          <p className="caption">Автопортрет із букетом квітів, 1933 рік. Фанера, олія. З приватної колекції (в експозиції Музею Новаківського)</p>
        </div>
        ...
        <div className="img">
          <img src={Zadum} alt="" />
          <p className="caption">О.Новаківський. «Дружина у задумі». Початок 1930-х рр.</p>
        </div>
        ...
        <div className="img">
          ...
          <p className='caption'>Автопортрет із музою, початок 1900-х років. Полотно, олія. З приватної колекції</p>
        </div>
        ...
        <div className="img">
          <img src={Gera} alt="" />
          <p className="caption">Гора Грегіт, 1931 рік. Фанера, олія. Зі збірки Національного музею у Львові</p>
        </div>
        ...
        <div className="img">
          <img src={Voina} alt="" />
          <p className="caption">Юр. Поема світової війни, 1916-1922 роки. Полотно на фанері, олія. З приватної колекції</p>
        </div>
        ...
        <div className="img">
          <img src={Probud} alt="" />
          <p className="caption">Пробудження на тлі розп»яття 1914 рік</p>
        </div>
      </div>
