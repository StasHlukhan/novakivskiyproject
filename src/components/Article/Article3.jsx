...
import Video1 from '../UI/VideoPlayer/Video1'
    ...
    <div>
     ...
     <div className="Article3">
        ...
        <div className="article_main">
            ...
            <h2 className='name_title'>{t('article3_name1')}</h2>
            <p className='article_text'>{t('article3_text1')}</p>
            <p className='article_text'>{t('article3_text2')}</p>
            <span className='article_text'>{t('article3_text3/1')}<p > <span className='surname_title'>{t('article3_surname2')}</span>{t('article3_text3/2')}</p></span>
            <p className='article_text'><span className='surname_title'>{t('article3_surname1')}</span>{t('article3_text4')}</p>
            <p className='article_text'><span className='surname_title'>{t('article3_surname2')}</span>{t('article3_text5')}</p>
            <p className='article_text'><span className='surname_title'>{t('article3_surname2')}</span>{t('article3_text6')}</p>
            <p className='article_text'><span className='surname_title'>{t('article3_surname1')}</span>{t('article3_text7')}</p>
            <p className='article_text'><span className='surname_title'>{t('article3_surname2')}</span>{t('article3_text8')}</p>
            <p className='article_text'><span className='surname_title'>{t('article3_surname1')}</span>{t('article3_text9')}</p>
            
            <h2 className="name_title">{t('article3_name2')}</h2>
            <p className='article_text'>{t('article3_text10')}</p>
            <p className='article_text'>{t('article3_text11')}</p>        
            <p className='article_text'>{t('article3_text12')}</p>
            <p className='article_text'>{t('article3_text13')}</p>
            <p className='article_text'>{t('article3_text14')}</p>
            <p className='article_text'>{t('article3_text15')}</p>

            <h2 className="name_title">{t('article3_name3')}</h2>
            <p className='article_text'>{t('article3_text16')}</p>
            <p className='article_text'>{t('article3_text17')}</p>
            <p className='article_text'>{t('article3_text18')}</p>
            <p className='article_text'>{t('article3_text19')}</p>
            <p className='article_text'>{t('article3_text20')}</p>
            <p className='article_text'>{t('article3_text21')}</p>

            <h2 className="name_title">{t('article3_name4')}</h2>
            <p className='article_text'>{t('article3_text22')}</p>
            <p className='article_text'>{t('article3_text23')}</p>    
            <p className='article_text'>{t('article3_text24')}</p>
            <p className='article_text'>{t('article3_text25')}</p>
            <p className='article_text'>{t('article3_text26')}</p>
            <p className='article_text'>{t('article3_text27')}</p>
            <p className='article_text'>{t('article3_text28')}</p>
            <p className='article_text'>{t('article3_text29')}</p>
            <p className='article_text'>{t('article3_text30')}</p>
            <p className='article_text'>{t('article3_text31')}</p>
            <p className='article_text'>{t('article3_text32')}</p>
        
            <h2 className="name_title">{t('article3_name5')}</h2>
            <div className='article_text'>{t('article3_text33')}
            <ul>
                <li className='article_li'>{t('article3_li1')}</li>
                <li className='article_li'>{t('article3_li2')}</li>
                <li className='article_li'>{t('article3_li3')}</li>
            </ul>
            {t('article3_text34')}
            <ul>
                <li className='article_li'>{t('article3_li4')}</li>
                <li className='article_li'>{t('article3_li5')}</li>
                <li className='article_li'>{t('article3_li6')}</li>
                <li className='article_li'>{t('article3_li7')}</li>
                <li className='article_li'>{t('article3_li8')}</li>
                <li className='article_li'>{t('article3_li9')}</li>
                <li className='article_li'>{t('article3_li10')}</li>
                <li className='article_li'>{t('article3_li11')}</li>
            </ul>
            </div>
